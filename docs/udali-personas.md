# UDALI coding personas (AADM delivery architecture)
...
For a **numbered L1–L22** slice list, zone grouping, and per-layer deep dive, see **[UDALI 22-layer model](udali-22-layer-model.md)**.

---

## Further reading

- [UDALI 22-layer model](udali-22-layer-model.md) — L1–L22 reference aligned to these personas  
